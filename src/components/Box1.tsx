...
const Box1 = () => {
  ...
  return (
    <div className="flex-center flex-col gap-5 w-full text-sm">
      <div className="flex-col flex-center gap-8 box relative px-12 py-6 w-full text-sm">
        <div className="flex-center text-[#888989] w-fit top-2.5 left-2.5 absolute text-sm">
          <CircleHelp size={20} />
        </div>
        <div className="side-line text-sm"></div>
        ...
        <div
          className="w-full bg-[#171717] rounded-[23px] flex p-2 text-sm"
          style={{
        ...
        >
          <button
            ...
            } flex-center min-[1400px]:px-10 px-5 py-2.5 w-full text-sm`}
          >
            About Me
          </button>
          <button
        ...
        <p className="w-full text-[#969696] text-base text-justify text-sm">
          {tab === "about" && (
            <>
